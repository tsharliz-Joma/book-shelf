...
function setupAnimation() {
  ...
  // INIT
  {
    ...
    gsap.set(".price-container", {
      perspective: 800,
    });
    gsap.set("#price-content", {
      transformStyle: "preserve-3d",
    });
    gsap.set(["#heads", "#tails"], {
  ...
  // FRAME 1
  {
    // phakathi
    tl.from(
      "#dash,#background,.border,#underline,#p1",
      {
        duration: 0.5,
        x: -250,
        ease: "power3.inOut",
    ...
    tl.from(
      "#copy-one-container,#logo-officeworks,#disclaimer,#underline",
      {
        duration: 0.5,
        opacity: 0,
        ease: "power2.out",
    ...
    tl.to(
      "#copy-one-container,#disclaimer,#underline",
      {
        duration: 0.25,
        opacity: 0,
        ease: "power2.inOut",
  ...
  //  FRAME 3
  {
    ...
    tl.to(
      "#colored_panel_2,#samsung-earbuds",
      {
        duration: 0.5,
        x: -bWidth,
        ease: "power2.inOut",
...
function getProp($class, $property) {
  return window
    .getComputedStyle(document.querySelector($class), null)
